...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2599739567863797239L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"org.fos.kafka.model.avro.order\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static org.fos.kafka.model.avro.order.Product.Builder newBuilder() {
    return new org.fos.kafka.model.avro.order.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.fos.kafka.model.avro.order.Product.Builder newBuilder(org.fos.kafka.model.avro.order.Product.Builder other) {
    if (other == null) {
      return new org.fos.kafka.model.avro.order.Product.Builder();
    } else {
      return new org.fos.kafka.model.avro.order.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.fos.kafka.model.avro.order.Product.Builder newBuilder(org.fos.kafka.model.avro.order.Product other) {
    if (other == null) {
      return new org.fos.kafka.model.avro.order.Product.Builder();
    } else {
      return new org.fos.kafka.model.avro.order.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.fos.kafka.model.avro.order.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.fos.kafka.model.avro.order.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.Product.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.Product.Builder clearQuantity() {
