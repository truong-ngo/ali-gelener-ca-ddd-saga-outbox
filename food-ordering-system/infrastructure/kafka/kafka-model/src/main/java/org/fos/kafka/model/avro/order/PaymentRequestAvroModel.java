...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5794006871051857866L;
  ...
  private org.fos.kafka.model.avro.order.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String customerId, java.lang.String orderId, java.math.BigDecimal price, java.time.Instant createdAt, org.fos.kafka.model.avro.order.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (org.fos.kafka.model.avro.order.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.fos.kafka.model.avro.order.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(org.fos.kafka.model.avro.order.PaymentOrderStatus value) {
   ...
   */
  public static org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder newBuilder() {
    return new org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder newBuilder(org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder();
    } else {
      return new org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder newBuilder(org.fos.kafka.model.avro.order.PaymentRequestAvroModel other) {
    if (other == null) {
      return new org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder();
    } else {
      return new org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.fos.kafka.model.avro.order.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder setPaymentOrderStatus(org.fos.kafka.model.avro.order.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.fos.kafka.model.avro.order.PaymentRequestAvroModel.Builder clearPaymentOrderStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (org.fos.kafka.model.avro.order.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
